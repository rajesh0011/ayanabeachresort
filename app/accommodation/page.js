...
export default function HotelRooms() {
  ...
  return (
    <>
      <Navbar />
          <HeroSlider
        image="/img/rooms-banner.webp"
        subtitle=""
        title="Plan Your Perfect Getaway"
        buttonText="Book Now"
      />

      <div className="bg-light bg-white relative">

      <div className="text-center max-w-4xl mx-auto mt-10">
        <h2 className="text-4xl font-cormorant font-bold text-[#1b3a4b] mb-4 mt-5">
          Our Rooms
        </h2>
                ...
                <SwiperSlide key={index} className="flex justify-center">
                  <div className="bg-white shadow-md overflow-hidden max-w-[380px] w-full">
                    ...
                    <div className="p-6">
                      ...
                      <p
                        className={`text-gray-600 text-sm transition-all ${expanded === index ? "line-clamp-none" : "line-clamp-2"
                          }`}
                      >
                        {room.description}
                      </p>
