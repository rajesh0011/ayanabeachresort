        ...
        <div className="container mx-auto px-4">
            ...
            {offers.map((offer) => (
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    {/* Text below card */}
                    <p className="mt-6 text-gray-700 font-serif text-lg">
                    “{offer.subtitle}”
                    </p>

                    <div className="flex items-center gap-6 mt-6">
                    <a href="" className="border border-[#143B4A] px-6 py-2 text-md text-[#143B4A] font-medium hover:bg-[#143B4A] hover:text-white transition">
                      Know More 
                    </a>
                    ...
                    <a
                    href={offer.link}
                    className="bg-[#143B4A] text-white px-6 py-2 text-md font-medium hover:bg-gray-800 transition"
                    >
                    Book Now
                    </a>
                    </div>
